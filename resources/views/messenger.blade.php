...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/template.dark.bundle.css') }}" media="">
</head>
...
<body>
    ...
    <div class="layout overflow-hidden">
                                                        ...
                                                        <div class="dropdown ms-5">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="#">Show less
                                                                        often</a></li>
                                                                <li><a class="dropdown-item" href="#">Hide</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
        ...
        <div class="offcanvas offcanvas-end offcanvas-aside" data-bs-scroll="true" data-bs-backdrop="false"
            tabindex="-1" id="offcanvas-more-group">
            <!-- Offcanvas Header -->
            ...
            <div class="offcanvas-body hide-scrollbar">
                ...
                <ul class="nav nav-pills nav-justified" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="pill" href="#offcanvas-group-tab-members"
                            role="tab" aria-controls="offcanvas-group-tab-members" aria-selected="true">
                            People
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="pill" href="#offcanvas-group-tab-media"
                            role="tab" aria-controls="offcanvas-group-tab-media" aria-selected="true">
                            Media
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="pill" href="#offcanvas-group-tab-files"
                            role="tab" aria-controls="offcanvas-group-tab-files" aria-selected="false">
                            Files
                        </a>
                    </li>
                </ul>
                            ...
                            <li class="list-group-item">
                                <div class="row align-items-center gx-5">
                                    ...
                                    <div class="col-auto">
                                        <div class="avatar-group">
                                            <a href="#" class="avatar avatar-sm">
                                                <img src="assets/img/avatars/6.jpg" class="avatar-img"
                                                    alt="#">
                                            </a>
                            ...
                            <li class="list-group-item">
                                <div class="row align-items-center gx-5">
                                    ...
                                    <div class="col-auto">
                                        <div class="avatar-group">
                                            <a href="#" class="avatar avatar-sm">
                                                <img class="avatar-img" src="assets/img/avatars/3.jpg"
                                                    alt="#">
                                            </a>
        ...
        <!-- Chat: Add member -->
        <div class="offcanvas offcanvas-end offcanvas-aside" data-bs-scroll="true" data-bs-backdrop="false"
            tabindex="-1" id="offcanvas-add-members">
            <!-- Offcanvas Header -->
            <div class="offcanvas-header py-4 py-lg-7 border-bottom ">
                <a class="icon icon-lg text-muted" href="#" data-bs-dismiss="offcanvas">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                <a class="icon icon-lg text-muted" data-bs-toggle="collapse" href="#search-members"
                    role="button" aria-expanded="false" aria-controls="search-members"
    ...
    <script type="module">
        ...
        var pusher = new Pusher('c44460f382323e0548cb', {
            cluster: 'ap2',
        ...
        var chatChannel = window.Echo.join('chat').listenForWhisper('typing', (e) => {
         console.log(e);
            });

        let time = false;
        $("body").on("keydown", "[name=message]", function(e) {
